...
model CommonDamperTandemBus
  ...
  Main.VAVSingleDuctBus ahu(
    redeclare Economizers.Data.CommonDamperTandem datEco(
      mExh_flow_nominal=1), redeclare EconomizersBus.CommonDamperTandem eco

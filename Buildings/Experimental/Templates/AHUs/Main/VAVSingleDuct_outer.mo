...
model VAVSingleDuct_outer "VAV single duct with relief"
  ...
  inner replaceable parameter Coils.Data.None datCoi
    ...
    annotation (Placement(transformation(extent={{-40,-150},{-20,-130}})),
      ...
      __Linkage(
        select(
          condition=typCoiCoo==Types.Coil.WaterBased and
            coiCoo.typHex==WetCoilCounterFlow,
          datCoi(redeclare parameter
            Buildings.Experimental.Templates.AHUs.Coils.HeatExchangers.Data.Discretized datHex))));
  ...
  replaceable Coils.None_outer coiCoo

...
model VAVSingleDuct_Economizer
  ...
  Fluid.Sources.Boundary_pT bou1(
    ...
    annotation (Placement(transformation(extent={{80,-10},{60,10}})));
equation
  connect(bou.ports[1], ahu.port_Out) annotation (Line(points={{-60,2},{-30,2},
          {-30,-10},{-20,-10}},color={0,127,255}));
  connect(ahu.port_Sup, bou1.ports[1]) annotation (Line(points={{20,-10},{30,
          -10},{30,2},{60,2}},
                          color={0,127,255}));
  connect(bou.ports[2], ahu.port_Exh) annotation (Line(points={{-60,-2},{-30,-2},
          {-30,10},{-20,10}}, color={0,127,255}));
  connect(ahu.port_Ret, bou1.ports[2]) annotation (Line(points={{20,10},{30,10},
          {30,-2},{60,-2}}, color={0,127,255}));

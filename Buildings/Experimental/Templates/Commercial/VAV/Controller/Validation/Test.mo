...
equation
  connect(yDeclaredPresent.y, subBus.yDeclaredPresent) annotation (Line(points={{-58,30},{-44,30},{-44,0.05},{-23.95,0.05}},
        color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
  ...
  connect(yDeclaredPresent.y, bus.yAct) annotation (Line(points={{-58,30},{-4,30},{-4,0.1},{52.1,0.1}}, color={0,0,127}),
      Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},

...
model TestCoilAndValve "Open loop test for air handler unit"
...
equation
  connect(out.ports[1], ahu.port_freAir) annotation (Line(points={{-70,0.666667},
          {-56,0.666667},{-56,6},{-34,6}},
                               color={0,127,255}));
  connect(out.ports[2], ahu.port_exhAir) annotation (Line(points={{-70,-2},{-56,
          -2},{-56,-10},{-34,-10}},
                                  color={0,127,255}));
end TestCoilAndValve;

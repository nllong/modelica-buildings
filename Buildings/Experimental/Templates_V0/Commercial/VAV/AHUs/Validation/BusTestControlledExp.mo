within Buildings.Experimental.Templates_V0.Commercial.VAV.AHUs.Validation;
model BusTestControlledExp
public
  Modelica.Blocks.Sources.RealExpression sensor(y=2 + sin(time*3.14))
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  Buildings.Experimental.Templates_V0.BaseClasses.AhuBus ahuBus annotation (
      Placement(transformation(extent={{-20,-20},{20,20}}), iconTransformation(
          extent={{-50,-10},{-30,10}})));

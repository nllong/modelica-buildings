...
model ControllerConfigurationTest "Validates multizone controller model for boolean parameter values"
  ...
  Buildings.Experimental.Templates_V0.Commercial.VAV.Controller.Controller conAHU(
    numZon=2,
    AFlo={50,50},
    have_winSen=false,
  ...
  Buildings.Experimental.Templates_V0.Commercial.VAV.Controller.Controller conAHU1(
    numZon=2,
    AFlo={50,50},
    have_winSen=false,
  ...
  Buildings.Experimental.Templates_V0.Commercial.VAV.Controller.Controller conAHU2(
    numZon=2,
    AFlo={50,50},
    have_winSen=true,
    have_perZonRehBox=true,
  ...
  Buildings.Experimental.Templates_V0.Commercial.VAV.Controller.Controller conAHU3(
    numZon=2,
    AFlo={50,50},
    have_winSen=false,
    have_perZonRehBox=true,
  ...
  Buildings.Experimental.Templates_V0.Commercial.VAV.Controller.Controller conAHU4(
    numZon=2,
    AFlo={50,50},
    have_winSen=false,
    have_perZonRehBox=true,

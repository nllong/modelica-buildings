...
equation
  connect(conVAVCor.TZon, TRooAirDem.y5[1]) annotation (Line(
      points={{528,94},{520,94},{520,275},{480,275}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(conVAVSou.TZon, TRooAirDem.y1[1]) annotation (Line(
      points={{700,94},{656,94},{656,40},{680,40},{680,275},{496,275}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TRooAirDem.y2[1], conVAVEas.TZon) annotation (Line(
      points={{492,275},{868,275},{868,94},{878,94}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TRooAirDem.y3[1], conVAVNor.TZon) annotation (Line(
      points={{488,275},{1028,275},{1028,94},{1036,94}},
      color={0,0,127},
      pattern=LinePattern.Dash));
  connect(TRooAirDem.y4[1], conVAVWes.TZon) annotation (Line(
  ...
  connect(conVAVWes.yZonPreResReq, PZonResReq.u[5]) annotation (Line(points={{1262,86},
        ...
        color={255,127,0}));
  connect(cor.VSup_flow, VDis_flow.u1[1]) annotation (Line(points={{612,56},{620,
          56},{620,74},{472,74},{472,206},{180,206},{180,340},{218,340}},
                                                                   color={0,0,
          127}));
  ...
  connect(wes.VSup_flow, VDis_flow.u5[1]) annotation (Line(points={{1332,56},{1340,
          56},{1340,74},{1286,74},{1286,204},{164,204},{164,320},{218,320}},
                                                                     color={0,0,
          127}));
  connect(cor.TSup, TDis.u1[1]) annotation (Line(points={{612,48},{620,48},{620,
  ...
  connect(TRooAir, zonOutAirSet.TZon) annotation (Line(points={{1140,506},{1164,
          506},{1164,660},{210,660},{210,590},{218,590}},           color={0,0,127}));
  ...
  connect(conAHU.ySupFanSpe, fanSup.y) annotation (Line(points={{424,618.667},{
          432,618.667},{432,-14},{310,-14},{310,-28}},
                                                   color={0,0,127}));
  connect(cor.y_actual,conVAVCor.yDam_actual)  annotation (Line(points={{612,40},
  ...
  connect(TRooAir, zonSta.TZon) annotation (Line(points={{1140,506},{1164,506},{
  ...
  connect(TRooAir, zonGroSta.TZon) annotation (Line(points={{1140,506},{1164,506},
          {1164,660},{-250,660},{-250,263},{-162,263}},
        color={0,0,127}));

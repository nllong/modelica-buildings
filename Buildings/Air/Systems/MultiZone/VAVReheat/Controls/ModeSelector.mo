within Buildings.Air.Systems.MultiZone.VAVReheat.Controls;
model ModeSelector "Finite State Machine for the operational modes"
  ...
  State unOccOff(
    mode=Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.unoccupiedOff,
    nIn=3,
    nOut=4) "Unoccupied off mode, no coil protection"
    annotation (Placement(transformation(extent={{-20,20},{0,40}})));
  State unOccNigSetBac(
    nOut=2,
    mode=Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.unoccupiedNightSetBack,
  ...
  State morWarUp(mode=Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.unoccupiedWarmUp,
                                                                            nIn=2,
  ...
  State occ(
    mode=Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.occupied,
    nIn=3)
    "Occupied mode"
  ...
  State morPreCoo(
    nIn=1,
    mode=Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.unoccupiedPreCool,
  ...
  Buildings.Controls.OBC.CDL.Logical.And and3
    ...
    annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=-90,
        origin={200,-70})));
  Modelica.Blocks.Math.BooleanToInteger modIni(integerTrue=Integer(Buildings.Air.Systems.MultiZone.VAVReheat.Controls.OperationModes.unoccupiedOff))

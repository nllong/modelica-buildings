within Buildings.Air.Systems.MultiZone.VAVReheat.Controls.Examples;
model OperationModes "Test model for operation modes"
  ...
  Modelica.Blocks.Sources.RealExpression TRooSetHea(y=if mode.y == Integer(
        Controls.OperationModes.occupied) then 293.15 else 287.15)
